(function ($) {
	...
	var Ayurveda = {
        ...
        color_switch: function(){
            ...
            $('.bill-period-active').css('color' , $(this).attr('color-code'));
 ...
 // Go Top Js
    ...
    // Menu js for Position fixed
	  $(window).scroll(function(){
        ...
        if (window_top > 500) {
            $('.pa-main-header').addClass('menu_fixed animated fadeInDown');
        } else {
            $('.pa-main-header').removeClass('menu_fixed animated fadeInDown');
        }
    });
    ;