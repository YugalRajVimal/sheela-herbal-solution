            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="prose prose-invert max-w-none">
                ...
                <p className="text-gray-light font-roboto mb-4">
                  Founded with the vision of bringing authentic Ayurvedic
                  remedies to every home, Sheela Herbal Company is dedicated to
                  providing safe, natural, and effective solutions for skin and
                  wellness challenges.
                </p>
                ...
                <p className="text-gray-light font-roboto mb-4">
                  ...
                  — are trusted by people across India for their ability to
                  soothe, heal, and restore balance using the power of Ayurveda.
                </p>

                <p className="text-gray-light font-roboto mb-4">
                  Based in India, we follow time-tested herbal traditions
                  combined with modern quality standards to ensure every product
                  we deliver is pure, effective, and reliable.
                </p>
        ...
        <section className="py-24 bg-black-theme-poor text-black relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10 text-center">
            ...
            <p className="text-gray-light font-roboto max-w-2xl mx-auto mb-10">
              ...
              natural healing through Ayurveda and creating effective remedies
              for skin wellness.
            </p>
                    ...
                    <div className="absolute inset-0 bg-white/70 backdrop-blur-sm flex flex-col justify-center items-center transition-all duration-300 p-8 opacity-0 md:group-hover:opacity-100">
                      <div className="max-w-xs">
                        ...
                        <p className="text-danger font-medium text-center mb-1 font-montserrat">
                          Founder. Visionary Leader. Advocate of Natural
                          Healing.
                        </p>
                        ...
                        <p className="text-black-theme-pure font-roboto text-center">
                          ...
                          developing trusted remedies for skin health. Under
                          their leadership, the company focuses on safe, herbal
